 ...
 !
 ! number of ES nodes =   0.625000000    
 ! percentage of total 640 ES nodes =    9.76562500E-02  %
 ! total memory available on these ES nodes (Gb) =    10.0000000    
 !
 ! min vector length =           25
 ! min critical vector length =           75
 !
 ! main process: total points per AB slice =       170985
 ...
 !
 ! time step =    2.0000000000000000E-003
 !
 ! attenuation uses:
 !  NSPEC_ATTENUATION =            1
 ! 
 ...
 ! ----------------------------------------------
 !
 ! size of arrays for the largest slice =    31.641468048095703       MB
 !                                      =    3.0899871140718460E-002  GB
 !
